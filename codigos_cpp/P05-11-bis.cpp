...
class beta {
  ...
  public:                  // inicializa el puntero a alfa
    ...
    void bfunc() {
      aptr->adata = 325;       // accede datos privados de alfa
    }
    void showb();
};
...
alpha::alpha() {             // constructor de alfa
  bptr1 = new beta(this);    
  cout << "Constructor de alpha, genere puntero bptr1 a beta" << endl;
  bptr2 = new beta(this);
  cout << "Constructor de alpha, genere puntero bptr2 a beta" << endl;
}
...
void beta::showb() {
  cout << endl << "Muestra de datos de beta" << endl;
  cout << "atpr->adata: " << aptr->adata << endl;
}
